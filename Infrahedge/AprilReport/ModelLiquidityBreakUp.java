...
public class ModelLiquidityBreakUp extends BaseTest {
	...
	{
		String sheetName = Pro + category + kpi+"breakUpData";
...
// getting all top level values from Model category
		for (int i = 1; i <= modelRows.size(); i++) {
			...
			WebElement assetDropDown = driver.findElement(By.xpath("//div[text()='Model' and @class='navsubClass ng-binding']"));
			assetDropDown.click();
