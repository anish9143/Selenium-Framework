...
import com.Infrahedge.PomPages.IPTAATEPage;
import com.Infrahedge.PomPages.IPTAAVaRPage;
...
public class IPTAATE extends BaseTest  {

	//public static  WebDriver driver;
	DatabaseConnectivity connect=new DatabaseConnectivity();
	@Test()
	
	public void fetch_IP_TAA_TE() throws InterruptedException, IOException, AWTException
	{
		
		Thread.sleep(2000);
		
		//Click on the Vol progress bar
		 IPTAATEPage ipTAATE= new IPTAATEPage(driver);
	     ipTAATE.clicktAATEProgressbar();
