...
public class VerifyTAATEAssetsUIEntities extends BaseTest {
	...
	public void testVolProgress() {
		...
		lPage.clickTETAAProgressBar();
	}

	@Test(priority = 2, description = "Verify Assets UI elements for IP1 In TAA category and KPI is TE")
	...
	@Test(priority = 3, description = "Verify Assets UI elements for IP2 In TAA category and KPI is TE")
	...
	@Test(priority = 4, description = "Verify Assets UI elements for IP3 In TAA category and KPI is TE")
	...
	@Test(priority = 5, description = "Verify Assets UI elements for IP4 In TAA category and KPI is TE")
	...
	@Test(priority = 5, description = "Verify Assets UI elements for IP5 In TAA category and KPI is TE")
	...
	@Test(priority = 6, description = "Verify Assets UI elements for IP5 In TAA category and KPI is TE")
	public void verifyDynamicTAAAssets() throws InterruptedException, IOException {
	...
	@Test(priority = 6, description = "Verify Assets UI elements for IP5 In TAA category and KPI is TE")
	public void verifyGAFTAAAssets() throws InterruptedException, IOException {
	...
	@Test(priority = 7, description = "Verify Assets UI elements for IP5 In TAA category and KPI is TE")
	public void verifyIMPTAAAssets() throws InterruptedException, IOException {
	...
	@Test(priority = 8, description = "Verify Assets UI elements for IP5 In TAA category and KPI is TE")
	public void verifyCharitiesTAAAssets() throws InterruptedException, IOException {
