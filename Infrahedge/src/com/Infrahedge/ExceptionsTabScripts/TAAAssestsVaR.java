...
public class TAAAssestsVaR extends BaseTest {
	...
	public void readassetSubAssetValue(String Pro, String category, String kpi)
		...
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("div.topLeftProgress")).click();
		List<WebElement> catRows = driver.findElements(By.xpath("//*[@id='QV019']//table/tbody/tr/td[2]"));
	...
	@Test
	public void fecthTAAssets() throws InterruptedException, IOException, AWTException {

		// Click on the VaR progress bar
	ValidLogin login = new ValidLogin();
	login.testLogin();
		IPTAAVaRPage vaRprogress= new IPTAAVaRPage(driver);
		vaRprogress.clicktAAVaRProgressbar();
