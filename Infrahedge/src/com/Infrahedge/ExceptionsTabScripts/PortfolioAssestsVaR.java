...
public class PortfolioAssestsVaR extends BaseTest {
	...
	public void readassetSubAssetValue(String Pro, String category, String kpi)
		...
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("div.topLeftProgress")).click();
		List<WebElement> catRows = driver.findElements(By.xpath("//*[@id='QV019']//table/tbody/tr/td[4]"));
		...
		for (int i = 1; i <= catRows.size(); i++) {
			Thread.sleep(2000);
			WebElement element = driver.findElement(By.xpath("//*[@id='QV019']//table/tbody/tr[" + i + "]/td[4]"));
	...
	@Test
	public void fecthPortfoliossets() throws InterruptedException, IOException, AWTException {

		// Click on the VaR progress bar
	ValidLogin login = new ValidLogin();
	login.testLogin();
		IPPortfolioVaRPage vaRprogress= new IPPortfolioVaRPage(driver);
		vaRprogress.clickPortfolioVaRProgressbar();
