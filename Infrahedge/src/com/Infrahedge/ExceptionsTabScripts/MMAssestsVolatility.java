...
public class MMAssestsVolatility extends BaseTest {
			...
			try {
				...
				for (int i = 1; i <= catRows.size(); i++) {
					...
					WebElement element = driver
							.findElement(By.xpath("//*[@id='QV019']//table/tbody/tr[" + i + "]/td[2]"));
					...
					for (int s = 1; s <= count; s++) {
						...
						if (text17 != text18) {
							...
							WebElement PortfolioElement = driver
									.findElement(By.xpath("//*[@id='QV019']//table/tbody/tr[18]/td[2]"));
	...
	public void fecthMMssets() throws InterruptedException, IOException, AWTException {
		...
		System.out.println("BUK is selected");
		Thread.sleep(2000);
		ipMMVol.clickMMVolProgressbar();
		System.out.println("MM is selected");
		Thread.sleep(1000);
