...
public class SAAAssestsVaR extends BaseTest {
	...
	public void readassetSubAssetValue(String Pro, String category, String kpi)
		...
		for (int i = 1; i <= catRows.size(); i++) {
			Thread.sleep(2000);
			WebElement element = driver.findElement(By.xpath("//*[@id='QV019']//table/tbody/tr[" + i + "]/td[1]"));
	...
	@Test
	public void fecthSAAssets() throws InterruptedException, IOException, AWTException {

		// Click on the VaR progress bar
	ValidLogin login = new ValidLogin();
	login.testLogin();
		IPSAAVaRPage vaRprogress= new IPSAAVaRPage(driver);
		vaRprogress.clicksAAVaRProgressbar();
