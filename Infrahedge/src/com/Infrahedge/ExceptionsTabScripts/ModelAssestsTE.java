...
public class ModelAssestsTE extends BaseTest {
	...
	public void readassetSubAssetValue(String Pro, String category, String kpi)
		...
		columnList.add("TAA Selection CTE");
		columnList.add("TAA Allocation CTE");
			...
			try {
				...
				for (int i = 1; i <= catRows.size(); i++) {
					...
					WebElement element = driver
							.findElement(By.xpath("//*[@id='QV019']//table/tbody/tr[" + i + "]/td[3]"));
	...
	public void fecthTEssets() throws InterruptedException, IOException, AWTException {
		...
		IPModelTEPage ipTETE = new IPModelTEPage(driver);
		Thread.sleep(2000);
		ipTETE.clickModelTEProgressbar();
