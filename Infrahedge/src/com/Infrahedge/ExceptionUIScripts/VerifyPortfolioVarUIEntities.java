...
public class VerifyPortfolioVarUIEntities extends BaseTest {
	...
	@Test(priority = 2, description = "Verify column name for IP1 in Portfolio categories and KPI is VaR")
	public void verfiyIP1Portfolio() throws InterruptedException {
		...
		categoryColumnNames.add("Model VaR");
		categoryColumnNames.add("Portfolio VaR");
	...
	@Test(priority = 4, description = "Verify column name for IP3 in Portfolio categories and KPI is VaR")
	...
	@Test(priority = 7, description = "Verify column name for Charities in Portfolio categories and KPI is VaR")
	...
	@Test(priority = 8, description = "Verify column name for Dynamic in Portfolio categories and KPI is VaR")
	...
	@Test(priority = 9, description = "Verify column name for GAF in Portfolio categories and KPI is VaR")
	...
	@Test(priority = 10, description = "Verify column name for IMP in Portfolio categories and KPI is VaR")
