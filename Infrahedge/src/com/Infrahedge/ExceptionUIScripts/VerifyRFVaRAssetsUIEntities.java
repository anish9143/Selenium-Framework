...
public class VerifyRFVaRAssetsUIEntities extends BaseTest {
	...
	@Test(priority = 2, description = "Verify Assets UI elements for IP1 In RF category and KPI is VaR")
	public void verifyIP1RFAssets() throws InterruptedException, IOException {

		Thread.sleep(5000);
		WebElement RFElement = driver.findElement(By.xpath("//*[@id='QV019']//table/tbody/tr/td[2]"));
		...
		WebElement assetDropDown = driver.findElement(By.xpath("(//*[text()='Regulated Fund'])[1]"));
		assetDropDown.click();
	...
	@Test(priority = 3, description = "Verify Assets UI elements for IP2 In RF category and KPI is VaR")
	...
	@Test(priority = 4, description = "Verify Assets UI elements for IP3 In RF category and KPI is VaR")
	...
	@Test(priority = 5, description = "Verify Assets UI elements for IP4 In RF category and KPI is VaR")
	...
	@Test(priority = 6, description = "Verify Assets UI elements for IP5 In RF category and KPI is VaR")
