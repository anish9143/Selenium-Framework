...
public class VerifyModelVarUIEntities extends BaseTest {
	...
	public void tesVarProgress() throws InterruptedException {
		...
		varPage.clickModelVarProgressBar();
		Thread.sleep(5000);

	}

	@Test(priority = 2, description = "Verify column name for IP1 in Model categories and KPI is VaR")
	...
	@Test(priority = 4, description = "Verify column name for IP3 in Model categories and KPI is VaR")
	...
	@Test(priority = 7, description = "Verify column name for Charities in Model categories and KPI is VaR")
	...
	@Test(priority = 8, description = "Verify column name for Dynamic in Model categories and KPI is VaR")
	...
	@Test(priority = 9, description = "Verify column name for GAF in Model categories and KPI is VaR")
	...
	@Test(priority = 10, description = "Verify column name for IMP in Model categories and KPI is VaR")
