...
public class VerifyModelVaRAssetsUIEntities extends BaseTest {
	...
	@Test(priority = 2, description = "Verify Assets UI elements for IP1 In Model category and KPI is VaR")
	...
	@Test(priority = 3, description = "Verify Assets UI elements for IP2 In Model category and KPI is VaR")
	...
	@Test(priority = 4, description = "Verify Assets UI elements for IP3 In Model category and KPI is VaR")
	...
	@Test(priority = 5, description = "Verify Assets UI elements for IP4 In Model category and KPI is VaR")
	...
	@Test(priority = 6, description = "Verify Assets UI elements for IP5 In Model category and KPI is VaR")
