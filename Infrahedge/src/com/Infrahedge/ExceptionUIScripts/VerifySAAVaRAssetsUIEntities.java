...
public class VerifySAAVaRAssetsUIEntities extends BaseTest {
	...
	@Test(priority = 2, description = "Verify Assets UI elements for IP1 In SAA category and KPI is VaR")
	public void verifyIP1SAAAssets() throws InterruptedException, IOException {
		...
		categoryColumnNames.add("SAA AC CVaR");
	...
	@Test(priority = 3, description = "Verify Assets UI elements for IP2 In SAA category and KPI is VaR")
	...
	@Test(priority = 4, description = "Verify Assets UI elements for IP3 In SAA category and KPI is VaR")
	...
	@Test(priority = 5, description = "Verify Assets UI elements for IP4 In SAA category and KPI is VaR")
	...
	@Test(priority = 6, description = "Verify Assets UI elements for IP5 In SAA category and KPI is VaR")
