...
public class VerifySAAVarUIEntities extends BaseTest {
	...
	public void tesVarProgress() throws InterruptedException {
		...
		varPage.clickSAAVarProgressbar();
		Thread.sleep(5000);

	}

	@Test(priority = 2, description = "Verify column name for IP1 in SAA categories and KPI is VaR")
	public void verfiyIP1SAA() throws InterruptedException {
		...
		categoryColumnNames.add("SAA AC VaR");
	...
	@Test(priority = 4, description = "Verify column name for IP3 in SAA categories and KPI is VaR")
	...
	@Test(priority = 6, description = "Verify column name for IP5 in SAA categories and KPI is VaR")
	...
	@Test(priority = 7, description = "Verify column name for Charities in SAA categories and KPI is VaR")
	...
	@Test(priority = 8, description = "Verify column name for Dynamic in SAA categories and KPI is VaR")
	...
	@Test(priority = 9, description = "Verify column name for GAF in SAA categories and KPI is VaR")
	...
	@Test(priority = 10, description = "Verify column name for IMP in SAA categories and KPI is VaR")
