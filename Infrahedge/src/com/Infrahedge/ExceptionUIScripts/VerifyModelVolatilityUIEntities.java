...
public class VerifyModelVolatilityUIEntities extends BaseTest {
	...
	@Test(priority = 2, description = "Verify Column Names for IP1 In Model category and KPI is Volatility")
	public void verifyIP1Model() throws InterruptedException {
	...
	@Test(priority = 3, description = "Verify Column Names for IP2 In Model category and KPI is Volatility")
	...
	@Test(priority = 4, description = "Verify Column Names for IP3 In Model category and KPI is Volatility")
	...
	@Test(priority = 5, description = "Verify Column Names for IP4 In Model category and KPI is Volatility")
	...
	@Test(priority = 6, description = "Verify Column Names for IP5 In Model category and KPI is Volatility")
	...
	@Test(priority = 7, description = "Verify Column Names for Charities In Model category and KPI is Volatility")
	public void verfiyCharitiesModel() throws InterruptedException
	{
		...
		test.log(Status.INFO, "Model Category in Charities has  " + columnCount + " Columns Displayed as : \n" + readColNames);

	
	}
	@Test(priority = 8, description = "Verify Column Names for Dynamic In Model category and KPI is Volatility")
	...
	@Test(priority = 9, description = "Verify Column Names for GAF In Model category and KPI is Volatility")
	public void verfiyGAFModel() throws InterruptedException
	{
		...
		test.log(Status.INFO, "Model Category in GAF has  " + columnCount + " Columns Displayed as : \n" + readColNames);

	
	}
	
	@Test(priority = 10, description = "Verify Column Names for IMP In Model category and KPI is Volatility")
	public void verfiyIMPModel() throws InterruptedException, IOException
	{
		...
		test.log(Status.INFO, "Model Category in IMP has  " + columnCount + " Columns Displayed as : \n" + readColNames);
