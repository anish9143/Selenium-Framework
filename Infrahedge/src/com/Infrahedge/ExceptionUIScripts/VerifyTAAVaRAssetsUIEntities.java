...
public class VerifyTAAVaRAssetsUIEntities extends BaseTest {
	...
	public void testVarProgress() {
		...
		varPage.clickTAAVarProgressbar();
	}

	@Test(priority = 2, description = "Verify Assets UI elements for IP1 In TAA category and KPI is VaR")
	...
	@Test(priority = 3, description = "Verify Assets UI elements for IP2 In TAA category and KPI is VaR")
	...
	@Test(priority = 4, description = "Verify Assets UI elements for IP3 In TAA category and KPI is VaR")
	...
	@Test(priority = 5, description = "Verify Assets UI elements for IP4 In TAA category and KPI is VaR")
	...
	@Test(priority = 6, description = "Verify Assets UI elements for IP5 In TAA category and KPI is VaR")
