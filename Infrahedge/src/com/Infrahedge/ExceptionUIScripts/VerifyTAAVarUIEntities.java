...
public class VerifyTAAVarUIEntities extends BaseTest {
	...
	@Test(priority = 2, description = "Verify column name for IP1 in TAA categories and KPI is VaR")
	...
	@Test(priority = 3, description = "Verify column name for IP2 in TAA categories and KPI is VaR")
	...
	@Test(priority = 4, description = "Verify column name for IP3 in TAA categories and KPI is VaR")
	...
	@Test(priority = 5, description = "Verify column name for IP4 in TAA categories and KPI is VaR")
	...
	@Test(priority = 6, description = "Verify column name for IP5 in TAA categories and KPI is VaR")
	...
	@Test(priority = 7, description = "Verify column name for Charities in TAA categories and KPI is VaR")
	...
	@Test(priority = 8, description = "Verify column name for Dynamic in TAA categories and KPI is VaR")
	...
	@Test(priority = 9, description = "Verify column name for GAF in TAA categories and KPI is VaR")
	...
	@Test(priority = 10, description = "Verify column name for IMP in TAA categories and KPI is VaR")
