...
public class VerifyExposureBUKEntity extends com.Infrahedge.generic.BaseTest {

	com.Infrahedge.PomPages.ExposurePages.ExposurePage exposure = new com.Infrahedge.PomPages.ExposurePages.ExposurePage(
			driver);
	...
	public void testExposureLink() throws InterruptedException {
		exposure = new com.Infrahedge.PomPages.ExposurePages.ExposurePage(driver);
	...
	@Test(priority = 4, description = "Test BUK Button")
	public void testBUKButton() throws InterruptedException {
		exposure.verifyBUKbutton();
	}
	...
	public void testModelAndAccounNumberElements() throws InterruptedException {
		exposure.verifyBUKbutton();
...
//
...

	{
		...
		WebElement creditRatingOption = driver
				.findElement(By.xpath("//*[text()='Credit Rating' and @title='Credit Rating']"));
