...
public class IPRegFundLiquidity extends BaseTest {
	...
	public void tesVarProgress() throws InterruptedException {
		...
		lPage.clickRFLiquiProgressBar();
		Thread.sleep(3000);

	}

	@Test(priority = 2, description = "Verify column name for IP1 in RF categories and KPI is Liquidity")
	...
	@Test(priority = 4, description = "Verify column name for IP3 in RF categories and KPI is Liquidity")
	...
	@Test(priority = 7, description = "Verify column name for Charities in RF categories and KPI is Liquidity")
	...
	@Test(priority = 8, description = "Verify column name for Dynamic in RF categories and KPI is Liquidity")
	...
	@Test(priority = 9, description = "Verify column name for GAF in RF categories and KPI is Liquidity")
