...
public class IPMMVolatilityPage extends BaseTest {
	...
	WebElement MMVolProgressbar;
	
	

	public IPMMVolatilityPage(WebDriver driver) {
	...
	public void clickMMVolProgressbar()
	{
		...
		try {
			WebElement element = wait.until(ExpectedConditions.visibilityOf(MMVolProgressbar));

			MMVolProgressbar.click();
